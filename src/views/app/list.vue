  ...
  <div>
    ...
    <Modal v-model="modalSetting.show"
      ...
      <Form ref="myForm"
        ...
        <FormItem label="应用名称"
                  prop="app_name">
          <Input v-model="formItem.app_name"
                 placeholder="请输入应用名称" />
        </FormItem>
        ...
        <FormItem label="AppSecret"
          ...
          <Button slot="append"
                  icon="md-refresh"
                  @click="refreshAppSecret">
          </Button>

        </FormItem>
        <FormItem label="应用分组"
                  prop="app_group">
          <Select v-model="formItem.app_group"
                  style="width:200px">
            <Option v-for="v in appGroup"
                    :value="v.hash"
                    :key="v.hash">
              {{v.name}}
            </Option>
          ...
          <Button icon="md-refresh"
                  @click="getAppGroups(true)">
          </Button>
        </FormItem>
        <FormItem label="应用描述"
                  prop="app_info">
          <Input v-model="formItem.app_info"
                 type="textarea" />
        </FormItem>
        <FormItem label="接口访问"
                  prop="app_api">
          <div class="api-box">
            <div class="api-group"
                 v-for="(apiArr, groupId) in groupList"
                 :key="groupId">
              <div style="border-bottom: 1px solid #e9e9e9;padding-bottom:6px;margin-bottom:6px;">
                <Checkbox :indeterminate="checkAllIndeterminate[groupId]"
