        ...
        <Form ref="myForm"
            ...
            <div class="demo-upload-list"
              ...
              <div class="demo-upload-list-cover">
                <Icon type="ios-trash-outline"
                      @click.native="handleImgRemove()"></Icon>
              </div>
            </div>
            <input v-if="formItem.headImg"
                   v-model="formItem.headImg"
                   type="hidden"
                   name="image">
            <Upload type="drag"
                    :action="uploadUrl"
          ...
          <div>
            ...
            <Button type="primary"
                    style="width: 100px;"
                    :loading="saveLoading"
                    @click="confirmSubmit">保存</Button>
          </div>
        </Form>
      </div>
    </Card>
    <Modal v-model="confirmSub"
           width="360">
      <p slot="header"
